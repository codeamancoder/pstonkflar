<?php
    ...
    $tid = TID;
    $posnetid = POSNETID;
    $ykbOOSURL = 'http://setmpos.ykb.com/3DSWebService/YKBPaymentService';
...
<form name="formName" method="post" action="<? echo $ykbOOSURL; ?>" target="YKBWindow">
  <div align="center"> 
    ...
    <p> <font size="2">
      ...
      <input name="merchantReturnURL" type="hidden" id="merchantReturnURL" value="http://www.pistonkafalar.com/pos/Web Test/kk_provizyon.php">
